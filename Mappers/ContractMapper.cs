    ...
    public static class ContractMapper
    {
        ...
        public static ContractDto ToContractDto(this Contract contractModel)
        {
            return new ContractDto
            {
                ...
                ProductVersionId = contractModel.ProductVersionId,
                ProductVersionCode = contractModel.ProductVersion?.VersionCode,
                ProductVersionName = contractModel.ProductVersion?.VersionName,
        ...
        public static Contract ToContractFromCreateDto(this CreateContractRequestDto contractDto)
        {
            return new Contract
            {
                ...
                ProductVersionId = contractDto.ProductVersionId,
