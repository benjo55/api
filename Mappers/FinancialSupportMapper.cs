    ...
    public static class FinancialSupportMapper
    {
        public static FinancialSupportDto ToFinancialSupportDto(this FinancialSupport model)
        {
            return new FinancialSupportDto
            {
                ...
                InternalManagementFeeRate = model.InternalManagementFeeRate,
                ...
                ContractManagementFeeOverrideRate = model.ContractManagementFeeOverrideRate,
                ContractManagementFeeOverrideFrequency = model.ContractManagementFeeOverrideFrequency,
                ContractManagementFeeOverrideProrataMethod = model.ContractManagementFeeOverrideProrataMethod,
                ContractManagementFeeOverridePostingMode = model.ContractManagementFeeOverridePostingMode,
                ContractManagementFeeOverrideEffectiveDate = model.ContractManagementFeeOverrideEffectiveDate,
                ContractManagementFeeOverrideEndDate = model.ContractManagementFeeOverrideEndDate,
                ContractManagementFeeOverrideEnabled = model.ContractManagementFeeOverrideEnabled,
