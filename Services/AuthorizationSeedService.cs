    ...
    public sealed class AuthorizationSeedService
    {
        ...
        public async Task SeedAsync(CancellationToken cancellationToken = default)
        {
            ...
            var roleDefinitions = new[]
            {
                ...
                new RoleDefinition(SystemRoles.LifeUser, "Utilisateur LIFE", 10, Array.Empty<string>()),
                new RoleDefinition(SystemRoles.CerfaUser, "Utilisateur CERFA", 10, Array.Empty<string>()),
                new RoleDefinition(SystemRoles.UrbanisationUser, "Utilisateur Urbanisation", 10, Array.Empty<string>()),
