...
{
    public sealed class ContractSheetDocumentDataProvider : IDocumentDataProvider
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var documentRequest = new GenerateContractSheetRequestDto
            {
                ContractId = contractId,
                FileName = ReadStringParameter(request, "fileName")
                    ?? $"fiche-contrat-{contractId.ToString(CultureInfo.InvariantCulture)}",
            ...
            return Task.FromResult<object>(new ContractSheetDocumentModel(documentRequest));
        }
